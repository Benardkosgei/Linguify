...
const KalenjinDashboard = ({navigation}) => {
  const learningModules = [
    {
      id: '1',
      icon: 'waving-hand',
      title: 'Greetings',
      description: 'Learn Kalenjin greetings and responses',
      color: '#8B5CF6',
      category: 'greetings',
    },
    {
      ...
      icon: 'translate',
      title: 'Basic Words',
      description: 'Essential Kalenjin vocabulary',
      color: '#10B981',
    ...
    },
    {
      ...
      icon: 'numbers',
      title: 'Numbers',
      description: 'Learn counting in Kalenjin',
      color: '#EF4444',
      category: 'numbers',
    },
    {
    ...
    },
    {
      ...
      icon: 'palette',
      title: 'Colors',
      description: 'Learn color names in Kalenjin',
      color: '#EC4899',
      category: 'colors',
    },
    {
    ...
    },
    {
      ...
      icon: 'restaurant',
      title: 'Food & Drinks',
      description: 'Traditional Kalenjin cuisine',
      color: '#06B6D4',
      category: 'food',
    },
    {
      ...
      icon: 'accessibility',
      title: 'Body Parts',
      description: 'Human body parts in Kalenjin',
      color: '#84CC16',
      category: 'body_parts',
    },
    {
    ...
    },
    {
      ...
      icon: 'person',
      title: 'Names',
      description: 'Traditional Kalenjin names and meanings',
      color: '#10B981',
      category: 'names',
    },
    {
  ...
  const practiceModules = [
    ...
    },
    {
      ...
      icon: 'quiz',
      title: 'Quiz',
      description: 'Test your Kalenjin knowledge',
      screen: 'Quiz',
      color: '#8B5CF6',
    }
  ];
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        if (item.screen) {
          ...
          navigation.navigate('KalenjinContent', {
            title: item.title, 
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Kalenjin - The Language of the Rift Valley</Text>
      </View>
      ...
      <View style={styles.welcomeCard}>
        <View style={styles.welcomeContent}>
          ...
          <View style={styles.welcomeText}>
            <Text style={styles.welcomeTitle}>Chamge! Welcome!</Text>
            <Text style={styles.welcomeDescription}>
              Discover the rich highland language of the Kalenjin people with 600+ authentic words, phrases, and cultural insights across 14 comprehensive categories.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.8}
        >
          <MaterialIcons name="cloud-download" size={20} color="#8B5CF6" />
          <Text style={styles.importButtonText}>Import Kalenjin Content</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={async () => {
            ...
            const { importKalenjinContent } = require('../../scripts/importKalenjin');
            const result = await importKalenjinContent();
      ...
      <View style={styles.sectionHeader}>
        ...
        <Text style={styles.sectionSubtitle}>Explore Kalenjin language and highland culture</Text>
      </View>
...
export default KalenjinDashboard;