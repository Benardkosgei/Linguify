...
const KambaDashboard = ({navigation}) => {
  const learningModules = [
    {
      id: '1',
      icon: 'waving-hand',
      title: 'Greetings',
      description: 'Learn Kamba greetings and responses',
      color: '#EF4444',
      category: 'greetings',
    },
    {
      ...
      icon: 'translate',
      title: 'Basic Words',
      description: 'Essential Kikamba vocabulary',
      color: '#10B981',
    ...
    },
    {
      ...
      icon: 'numbers',
      title: 'Numbers',
      description: 'Learn counting in Kikamba',
      color: '#3B82F6',
      category: 'numbers',
    },
    {
    ...
    },
    {
      ...
      icon: 'palette',
      title: 'Colors',
      description: 'Learn color names in Kamba',
      color: '#F59E0B',
      category: 'colors',
    },
    {
    ...
    },
    {
      ...
      icon: 'restaurant',
      title: 'Food & Drinks',
      description: 'Traditional Kamba cuisine',
      color: '#06B6D4',
      category: 'food',
    },
    {
      ...
      icon: 'accessibility',
      title: 'Body Parts',
      description: 'Human body parts in Kikamba',
      color: '#84CC16',
      category: 'body_parts',
    },
    {
    ...
    },
    {
      ...
      icon: 'person',
      title: 'Names',
      description: 'Traditional Kamba names and meanings',
      color: '#10B981',
      category: 'names',
    },
    {
  ...
  const practiceModules = [
    ...
    },
    {
      ...
      icon: 'quiz',
      title: 'Quiz',
      description: 'Test your Kamba knowledge',
      screen: 'Quiz',
      color: '#EF4444',
    }
  ];
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        if (item.screen) {
          ...
          navigation.navigate('KambaContent', {
            title: item.title, 
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Learn Kamba</Text>
        <Text style={styles.headerSubtitle}>Kikamba - The Language of Eastern Kenya</Text>
      </View>
      ...
      <View style={styles.welcomeCard}>
        <View style={styles.welcomeContent}>
          ...
          <View style={styles.welcomeText}>
            <Text style={styles.welcomeTitle}>Wĩ ata! Welcome!</Text>
            <Text style={styles.welcomeDescription}>
              Discover the rich language of the Kamba people with 600+ authentic words, phrases, and cultural insights across 14 comprehensive categories.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.8}
        >
          <MaterialIcons name="cloud-download" size={20} color="#EF4444" />
          <Text style={styles.importButtonText}>Import Kamba Content</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={async () => {
            ...
            const { importKambaContent } = require('../../scripts/importKamba');
            const result = await importKambaContent();
      ...
      <View style={styles.sectionHeader}>
        ...
        <Text style={styles.sectionSubtitle}>Explore Kikamba language and Eastern Kenya culture</Text>
      </View>
