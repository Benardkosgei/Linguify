...
const KikuyuDashboard = ({navigation}) => {
  const learningModules = [
    {
      id: '1',
      icon: 'waving-hand',
      title: 'Greetings',
      description: 'Learn Kikuyu greetings and responses',
      color: '#6366F1',
      category: 'greetings',
    },
    {
    ...
    },
    {
      ...
      icon: 'numbers',
      title: 'Numbers',
      description: 'Learn counting in Gĩkũyũ',
      color: '#3B82F6',
      category: 'numbers',
    },
    {
    ...
    },
    {
      ...
      icon: 'palette',
      title: 'Colors',
      description: 'Learn color names in Kikuyu',
      color: '#F59E0B',
      category: 'colors',
    },
    {
    ...
    },
    {
      ...
      icon: 'person',
      title: 'Names',
      description: 'Traditional Kikuyu names and meanings',
      color: '#10B981',
      category: 'names',
    },
    {
  ...
  const practiceModules = [
    ...
    },
    {
      ...
      icon: 'quiz',
      title: 'Quiz',
      description: 'Test your Kikuyu knowledge',
      screen: 'Quiz',
      color: '#3B82F6',
    }
  ];
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        if (item.screen) {
          ...
          navigation.navigate('KikuyuContent', {
            title: item.title, 
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Gĩkũyũ - Central Kenya's Heritage Language</Text>
      </View>
      ...
      <View style={styles.welcomeCard}>
        <View style={styles.welcomeContent}>
          ...
          <View style={styles.welcomeText}>
            <Text style={styles.welcomeTitle}>Wamũkĩra! Welcome!</Text>
            <Text style={styles.welcomeDescription}>
              Discover the rich language of the Kikuyu people with 500+ authentic words, phrases, and cultural insights across 14 comprehensive categories.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.8}
        >
          <MaterialIcons name="cloud-download" size={20} color="#6366F1" />
          <Text style={styles.importButtonText}>Import Kikuyu Content</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={async () => {
            console.log('🚀 Starting Kikuyu content import...');
            // We'll create this import function
            const { importKikuyuContent } = require('../../scripts/importKikuyu');
            const result = await importKikuyuContent();
      ...
      <View style={styles.sectionHeader}>
        ...
        <Text style={styles.sectionSubtitle}>Explore Kikuyu language and culture</Text>
      </View>
...
export default KikuyuDashboard;