...
const KiswahiliContent = ({ route, navigation }) => {
  ...
  const loadContent = () => {
    try {
      ...
      // Set up real-time listener using React Native Firebase
    ...
    <View style={styles.emptyState}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          Alert.alert(
            'Import Content',
            'Would you like to import Kiswahili content for this category?',
            [
...
export default KiswahiliContent;