...
const KisiiContent = ({ route, navigation }) => {
    ...
    <View style={styles.contentCard}>
      ...
      {item.cultural_note && (
        <View style={styles.culturalNote}>
          <MaterialIcons name="info" size={16} color="#06B6D4" />
    ...
    <View style={styles.emptyState}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          Alert.alert(
            'Import Content',
            'Would you like to import Kisii content for this category?',
            [
